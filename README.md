...
- [Thumbnail & Graphics](#thumbnail--graphics)
...
_Tools for recording, editing, and producing video content._
...
- Desktop Editors
  ...
  - [Shotcut](https://shotcut.org/) - Cross-platform editor with native timeline editing.
- Programmatic Video
  - [Auto-Editor](https://github.com/WyattBlue/auto-editor) - Automatically removes silence from videos. Great for podcasts and talking-head content.
  - [Editly](https://github.com/mifi/editly) - Create videos programmatically via JSON. Useful for templated content.
...
_Recording, editing, hosting, and distribution for podcasters._
...
- Enhancement
  ...
  - [Auphonic](https://auphonic.com/) - Automatic leveling and loudness normalization.
  - [Spleeter](https://github.com/deezer/spleeter) - Deezer's audio stem separator. Splits songs into vocals, drums, bass, and more.
  - [Ultimate Vocal Remover](https://github.com/Anjok07/ultimatevocalremovergui) - Isolate vocals from music using deep learning. Desktop GUI included.
...
- Bots & Automation
  ...
  - [StreamElements](https://streamelements.com/) - All-in-one streaming toolkit with bot, overlays, and alerts.
...
- [Mautic](https://github.com/mautic/mautic) - Self-hosted marketing automation with email campaigns, segmentation, and workflows.
- [Plunk](https://github.com/useplunk/plunk) - Open-source email platform with transactional, campaign, and automation features.
- [Substack](https://substack.com/) - Newsletter platform with built-in monetization.
...
_Build and manage your community._

- [Chatwoot](https://github.com/chatwoot/chatwoot) - Open-source engagement across chat, email, and social channels. Unified inbox.
- [Circle](https://circle.so/) - Community platform for paid memberships.
...
_Get found on YouTube and search engines._

- [Answer Socrates](https://answersocrates.com/) - Turns a keyword into hundreds of questions people actually search for.
- [Exploding Topics](https://explodingtopics.com/) - Discover trending topics and niches before they go mainstream.
